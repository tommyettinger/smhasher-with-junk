...
if (ENDIAN_DETECT_BUILDTIME AND (NOT DEFINED DETECTED_LITTLE_ENDIAN))
  ...
  if(DEFINED CMAKE_16BIT_TYPE)
    ...
    configure_file(
      "${CMAKE_ROOT}/Modules/TestEndianness.c.in"
      "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/TestEndianness.c"
      @ONLY)

    file(READ "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/TestEndianness.c" TEST_ENDIANNESS_FILE_CONTENT)
    ...
    if(RESULT_ENDIAN_COMPILE)
      file(STRINGS
        "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/TestEndianness.bin"
	CMAKE_TEST_ENDIANNESS_STRINGS_LE
	LIMIT_COUNT 1
	REGEX "THIS IS LITTLE ENDIAN")
      file(STRINGS
        "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/TestEndianness.bin"
	CMAKE_TEST_ENDIANNESS_STRINGS_BE
	LIMIT_COUNT 1
	REGEX "THIS IS BIG ENDIAN")
    endif()
  endif()

  if((DEFINED CMAKE_TEST_ENDIANNESS_STRINGS_LE) AND (DEFINED CMAKE_TEST_ENDIANNESS_STRINGS_BE))
    if(NOT (CMAKE_TEST_ENDIANNESS_STRINGS_BE  AND  CMAKE_TEST_ENDIANNESS_STRINGS_LE))
