...
static inline uint64_t wheathash(const void* key, uint64_t len, uint64_t seed){
    ...
    case 10: seed = _wheatmum(_wheatr32(p) - seed, _wheatr32(p + 4) ^ _wheatp2) + _wheatmum(seed ^ _wheatp5, _wheatr16(p + 8) ^ _wheatp3); break;
    case 11: seed = _wheatmum(_wheatr32(p) - seed, _wheatr32(p + 4) ^ _wheatp2) + _wheatmum(seed ^ _wheatr16(p + 8), (_wheatr08(p + 10)) ^ _wheatp3); break;
    case 12: seed = _wheatmum(_wheatr32(p) - seed, _wheatr32(p + 4) ^ _wheatp2) + _wheatmum(seed ^ _wheatr16(p + 8), (_wheatr16(p + 10)) ^ _wheatp4); break;
    case 13: seed = _wheatmum(_wheatr32(p) - seed, _wheatr32(p + 4) ^ _wheatp0) + _wheatmum(seed ^ _wheatr32(p + 8), _wheatp5 + (_wheatr08(p + 12))); break;
    case 14: seed = _wheatmum(_wheatr32(p) - seed, _wheatr32(p + 4) ^ _wheatp0) + _wheatmum(seed ^ _wheatr32(p + 8), _wheatp5 + (_wheatr16(p + 12))); break;
    case 15: seed = _wheatmum(_wheatr32(p) - seed, _wheatr32(p + 4) ^ _wheatp0) + _wheatmum(seed ^ _wheatr32(p + 8), _wheatp5 + (_wheatr16(p + 12) << 8 | _wheatr08(p + 14))); break;
    }
    seed = (seed ^ len) * (_wheatp0 ^ seed << 16);
