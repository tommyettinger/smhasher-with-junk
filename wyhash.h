...
//	case	4:	seed = _wymix0(_wyr32(p), _wyp4, seed);	break;
//	case	5:	seed = _wymix0((_wyr32(p) << 8) | _wyr08(p + 4), _wyp4, seed);	break;
//	case	6:	seed = _wymix0((_wyr32(p) << 16) | _wyr16(p + 4), _wyp4, seed);	break;
//	case	7:	seed = _wymix0((_wyr32(p) << 24) | (_wyr16(p + 4) << 8) | _wyr08(p + 6), _wyp4, seed);	break;
//	case	8:	seed = _wymix0(__wyr64(p), _wyp4, seed);	break;
...
//	case	17:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1(_wyr08(p + 16), _wyp4, seed);	break;
//	case	18:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1(_wyr16(p + 16), _wyp4, seed);	break;
//	case	19:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1((_wyr16(p + 16) << 8) | _wyr08(p + 16 + 2), _wyp4, seed);	break;
//	case	20:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1(_wyr32(p + 16), _wyp4, seed);	break;
//	case	21:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1((_wyr32(p + 16) << 8) | _wyr08(p + 16 + 4), _wyp4, seed);	break;
//	case	22:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1((_wyr32(p + 16) << 16) | _wyr16(p + 16 + 4), _wyp4, seed);	break;
//	case	23:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1((_wyr32(p + 16) << 24) | (_wyr16(p + 16 + 4) << 8) | _wyr08(p + 16 + 6), _wyp4, seed);	break;
//	case	24:	seed = _wymix0(__wyr64(p), __wyr64(p + 8), seed) ^ _wymix1(__wyr64(p + 16), _wyp4, seed);	break;
