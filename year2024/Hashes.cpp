...
uint64_t
dottyhash64 (const void *buf, size_t len, uint64_t seed)
{
  ...
  switch (len & 7)
    {
    case 7:
      b ^= (uint64_t)pos2[6] << 48;
    case 6:
      b ^= (uint64_t)pos2[5] << 40;
    case 5:
      b ^= (uint64_t)pos2[4] << 32;
    case 4:
      b ^= (uint64_t)pos2[3] << 24;
    case 3:
      b ^= (uint64_t)pos2[2] << 16;
    case 2:
      b ^= (uint64_t)pos2[1] << 8;
    case 1:
      b ^= (uint64_t)pos2[0];
