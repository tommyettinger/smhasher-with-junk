...
# endif /* T1HA0_AESNI_AVAILABLE */
  ...
  { waterhash_test,              32, 0x59B8541C, "waterhash",       "waterhash (portable, 32-bit, little-endian)", GOOD },
  { wheathash_test,              64, 0x7625AEEC, "wheathash",       "wheathash (portable, 64-bit, little-endian)", GOOD },
  { woothash_test,               64, 0x23968DAB, "woothash",        "woothash (portable, 64-bit, little-endian)", GOOD },
  { woot32_test,                 32, 0x5D0AD3FC, "woot32",          "woot32 (portable, 32-bit, little-endian)", GOOD },
  { Hive,                        64, 0x7625AEEC, "Hive",            "Hive (portable, 64-bit, little-endian)", GOOD },
  { Wisp,                        64, 0x7625AEEC, "Wisp",            "Wisp (portable, 64-bit, little-endian)", GOOD },
  { TabOAAT_test,                64, 0x7625AEEC, "TabOAAT",         "TabOAAT (portable, 64-bit, little-endian)", GOOD }
};
